...
class Account:
    ...
    def repay_loan(self, amount):
        ...
        if amount >= self._loan:
            self._add_transaction(self._loan, 'repayment', "Loan fully repaid")
            self._loan = 0
            return "Loan fully repaid."
        else:
            self._loan -= amount
            self._add_transaction(amount, 'repayment', f"Loan partially repaid: {amount}")
    ...
    def close_account(self):
        ...
        self._loan = 0
        self._closed = True
        return "Account closed and all data reset."
